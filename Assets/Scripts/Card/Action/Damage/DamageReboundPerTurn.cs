...
//Rebound damage
public class DamageReboundPerTurn : ICardAction, IActorTurnStartListener, IStrategyDecorator<AttackInfo>, IBuff
{
    ...
    public void OnTurnStart()
    {
        ...
        if (_turns <= 0)
        {
            this._actor.UnderAttackDecoratorList.RemoveItem(this);
